...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  registerForm.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        window.location.href = "habits.html"; // Redirect to home page
      }, 1000); // 1 second delay
    } catch (error) {
  ...
  googleBtn.addEventListener("click", async () => {
    ...
    try {
      ...
      window.location.href = "habits.html"; // Redirect to the dashboard
    } catch (error) {
    ...
    try {
      ...
      if (isAuthenticated) {
        ...
        if (snapshot.exists()) {
          ...
          window.location.href = "habits.html"; // Redirect to the dashboard if biometric authentication is successful
        } else {
